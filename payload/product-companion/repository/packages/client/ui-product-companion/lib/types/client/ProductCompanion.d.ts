...
type ProductCompanionProps = PropsRuntime<'shell.overlay'> & PropsStore<ReturnType<typeof createCompanionStore>> & PropsLocale<'productCompanion'> & ProductCompanionInjected;
...
export declare function ProductCompanion({ useSessions, useStore, actions, startSession, openSession, t, }: ProductCompanionProps): import("react").JSX.Element | null;
export {};
